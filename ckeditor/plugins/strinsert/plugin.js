...
CKEDITOR.plugins.add('strinsert',
{
	...
	init : function( editor )
	{
		...
		strings.push(['<p><strong>MITCH VANDEWERDT-HOLMAN</strong><br />CPSU Victorian Assistant Branch Secretary</p>', 'Mitch Vandewerdt-Holman', 'Mitch Vandewerdt-Holman']);
		strings.push(['<p><strong>JISELLE HANNA</strong><br />CPSU Victorian Branch Secretary</p>', 'Jiselle Hanna', 'Jiselle Hanna']);
